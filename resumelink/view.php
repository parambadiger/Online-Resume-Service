        ...
        <main>
            ...
            <div id="skills">
                ...
                <table>
                    ...
                    <tbody>
                        <tr><td>WEB SKILLS</td><td><?php echo $row['skill'];?></td></tr>
                        <tr><td>WEB TOOLS</td><td><?php echo $row['tool'];?></td></tr>
                        <tr><td>DATABASE</td><td><?php echo $row['db'];?></td></tr>
                        <tr><td>OPERATING SYSTEMS</td><td><?php echo $row['sos'];?></td></tr>
                    </tbody>
                </table>
            </div>
            ...
            <div id="project">
                <table>
                    ...
                    <tbody>
                        ...
                        <tr><td>TECHNOLOGIES USED</td><td><?php echo $row['tech'];?></td></tr>
                        <tr><td>DATABASE</td><td><?php echo $row['srvr'];?></td></tr>
                        <tr><td>OPERATING SYSTEM</td><td><?php echo $row['pos'];?></td></tr>
