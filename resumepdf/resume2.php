...
<head>
    ...
    <div id="part2">          
        ...
        <table>
            <tr><td>Web Skills</td><td>'.$_POST['skill'].'</td></tr>
            <tr><td>Web Tools</td><td>'.$_POST['tool'].'</td></tr>
            <tr><td>Database</td><td>'.$_POST['db'].'</td></tr>
            <tr><td>Operating System</td><td>'.$_POST['sos'].'</td></tr>
        </table>
        ...
        <table>
            ...
            <tr><td>Technologies Used</td><td>'.$_POST['tech'].'</td></tr>
            <tr><td>Server</td><td>'.$_POST['srvr'].'</td></tr>
            <tr><td>Operating System</td><td>'.$_POST['pos'].'</td></tr>
