<?php
    ...
    VALUES (NULL,'$objective','$allcourse','$alluniversity','$allresult','$allpassout','$allsummury','$allskill','NULL','NULL','NULL','$title','NULL','NULL','$team','NULL','$desp','$allactivities','$allstrength','$fname','$lname','$bday','$gender','$pnum','$gid','$caddress','$paddress','$languages','$marital','$facebook','$linkedin','$twitter','$googleplus','$photo')";
