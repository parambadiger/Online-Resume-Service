...
$(function() {
        ...
        $('#addacademics').live('click', function() { 
                ...
                '<p>Passout Year<input type="number" class="form-control"  name="passout['+i+']" placeholder="Enter Passout Year"><a href="#" id="removeacademics">Remove</a></p></div>').appendTo('#education');
                i++;
                return false;
        });
...
$(function() {
        ...
        $('#addskill').live('click', function() { 
                $('<p>Skills<textarea type="text" class="form-control"  name="skill['+i+']" placeholder="Enter Computer Skill"></textarea><a href="#" id="removeskill">Remove</a></p>').appendTo('#technical_skill');
                i++;
                return false;
        });
