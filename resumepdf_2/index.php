        ...
        <div id="content">
            ...
            <div id="form4">
                ...
                <div id="technical_skill">
                    <p>Skills<textarea type="text" class="form-control"  name="skill[0]" placeholder="Enter Computer Skill"></textarea></p>
                </div>
                <button class="btn btn-info" id="addskill">Add</button>
                <ul class="pager">
